...
public class ReadCsvToCK {

    public static void main(String[] args) {
        //读取本地文件写入clickhouse
        readCsvByBufferedReader("/Users/ivan/dev/applications/git/learn/learn-java-clickhouse/src/main/resources/d_item_cat_level.txt", "click", "d_item_cat_level");
